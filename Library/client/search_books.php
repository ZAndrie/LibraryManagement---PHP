...
<nav class="navbar">
    ...
    <div style="display: flex; gap: 15px;">
        ...
        <a href="../client/dashboard.php" class="btn"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
    ...
    <div class="container">
        ...
        <?php if (!empty($search) || !empty($title) || !empty($author) || !empty($category) || !empty($isbn) || !empty($year_from) || !empty($year_to) || !empty($availability)): ?>
            ...
            <div class="active-filters">
                ...
                <?php if (!empty($isbn)): ?>
                    <span class="filter-badge">
                        ISBN: <?php echo htmlspecialchars($isbn); ?>
                    </span>
                <?php endif; ?>
                <?php if (!empty($year_from) || !empty($year_to)): ?>
                    <span class="filter-badge">
                        Year: <?php echo $year_from ?: '—'; ?> to <?php echo $year_to ?: '—'; ?>
                    </span>
                <?php endif; ?>
                <?php if (!empty($availability)): ?>
                    <span class="filter-badge">
                        <?php echo ucfirst($availability); ?> Books
                    </span>
                <?php endif; ?>
            </div>
